  ...
  public void doPost(HttpServletRequest request, HttpServletResponse response) throws IOException {
    ...
    try {
      ...
      while(characterNamesScanner.hasNext()){
        String characterName = characterNamesScanner.nextLine();
        Entity characterEntity = new Entity("characterVotes", characterName);
        characterEntity.setProperty("numVotes", 0);
